...
import { idlFactory } from './shopping_backend.did.js';
export { idlFactory } from './shopping_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SHOPPING_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./shopping_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the shopping_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./shopping_backend.did.js")._SERVICE>}
 */
export const shopping_backend = createActor(canisterId);
