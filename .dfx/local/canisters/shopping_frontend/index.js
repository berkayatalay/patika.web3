...
import { idlFactory } from './shopping_frontend.did.js';
export { idlFactory } from './shopping_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SHOPPING_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./shopping_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the shopping_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./shopping_frontend.did.js")._SERVICE>}
 */
export const shopping_frontend = createActor(canisterId);
